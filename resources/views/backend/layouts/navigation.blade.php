<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
            <a href="{{ route('admin.dashboard') }}"> <span class="logo-name">Grocerymart</span>
            </a>
        </div>
        <ul class="sidebar-menu">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="widget-chart.html">Add Banner</a></li>
                    <li><a class="nav-link" href="widget-data.html">All Banners</a></li>
                </ul>
            </li>
            <li class="dropdown">
                <a href="#" class="menu-toggle nav-link has-dropdown"><i
                        data-feather="align-justify"></i><span>Caregories</span></a>
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="chat.html">Add Category</a></li>
                    <li><a class="nav-link" href="portfolio.html">All Categories</a></li>
                    <li><a class="nav-link" href="blog.html">All Subcategory</a></li>
                </ul>
            </li>
            <li class="dropdown">
                <a href="#" class="menu-toggle nav-link has-dropdown"><i
                ...
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="email-inbox.html">Add Product</a></li>
                    <li><a class="nav-link" href="email-compose.html">All Products</a></li>
                </ul>
            </li>
